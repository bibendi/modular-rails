...
module CoreBy
  class QueryRoot < Schema::Object
    field :time, Types::DateTime, "Current server time", null: false
    field :job_status, Types::JSONString, "Check the status of a job", null: true do
    ...
    field :member, Types::User, "Member record", null: false do
  ...
  ActiveSupport.run_load_hooks("core_by/application_schema/query_root", QueryRoot)
end
