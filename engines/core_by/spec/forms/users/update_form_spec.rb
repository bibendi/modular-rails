...
describe CoreBy::Users::UpdateForm do
  ...
  it "publishes event" do
    expect { subject }.to have_published_event(CoreBy::SDK::Users::Updated)
      .with(
        user: user.to_entity,
  ...
  context "when login is empty" do
    ...
    it { expect { subject }.not_to have_published_event(CoreBy::SDK::Users::Updated) }
  end
  ...
  context "when login is not provided" do
    ...
    it { expect { subject }.to have_published_event(CoreBy::SDK::Users::Updated) }
  end
end
